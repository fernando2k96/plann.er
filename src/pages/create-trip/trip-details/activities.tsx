        ...
        {activities.map(category => {
            return (
               ...
               {category.activities.length > 0 ? (
                  <div>
                    {category.activities.map(activity => {
                        return (
                            ...
                            <span className="text-zinc-400 text-sm ml-auto">{format(activity.occurs_at, 'HH:mm')}h
                ...
                <p className="text-zinc-500 text-sm">Nenhuma ativiade cadastrada nessa data.</p>
               )}
            </div>
